                ...
                {contents.founders.map((content, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            <div className='md:w-[150px] md:h-[200px] h-[200px] w-full rounded-md relative shrink-0 bg-[rgba(26,26,26,1)]'>
                                <Image src={content.image} alt={content.name} height={100} width={100} className='object-cover h-full w-full rounded-md' />
                                <div className='flex flex-col w-full p-2 bg-gradient-to-t from-black/60 via-black/40 to-black/10 absolute bottom-0'>
                                    <span className='truncate text-sm font-chakra font-semibold'>{content.name}</span>
