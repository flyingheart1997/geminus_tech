            ...
            >
                <div className='flex flex-col sm:gap-4 gap-2'>
                    ...
                    <span className="text-[clamp(24px,5vw,50px)] leading-[1.2] text-center md:text-start font-bold font-chakra text-white">
                        The Best Systems Understand People, Not Just Code.
                    </span>
                </div>
                <div className='flex sm:gap-4 gap-2 w-full items-center justify-center md:justify-start md:items-start text-center md:text-start'>
                    <div className='flex gap-2 sm:w-[80%] lg:w-[70%] w-full flex-col'>
                        <span className='text-white opacity-[0.6] text-[clamp(14px,2.2vw,16px)]'>We’ve always been true to our ethos. The culture we built - that’s what I take the most pride in.</span>
                        <span className="text-[clamp(16px,2.5vw,18px)] font-sans text-white">
                            — Rahul Soman (Co-founder)
                        </span>
                    </div>
                </div>
            </motion.div>
