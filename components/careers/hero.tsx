    ...
    return (
        <section id='hero' className="h-screen w-screen relative flex items-center justify-center py-[clamp(24px,6vw,32px)] md:p-0 gap-[clamp(16px,4vw,30px)] md:gap-[clamp(20px,6vw,40px)] overflow-hidden">
            <motion.div
                ...
                <Image src="/career/bg_career.svg" alt="arrow down" height={100} width={100} className="object-contain w-full opacity-60" />
            </motion.div>
            <motion.div
            ...
            >
                <div className='flex flex-col sm:gap-4 gap-2'>
                    ...
                    <span className="text-[clamp(24px,5vw,50px)] w-[70%] self-center md:self-start font-chakra leading-[1.2] text-center md:text-start font-bold text-white">
