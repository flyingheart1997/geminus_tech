            ...
            >
                <div className='flex flex-col sm:gap-4 gap-2'>
                    <div className='flex gap-2 items-center w-full md:justify-start justify-center'>
                        <span className='text-white opacity-[0.6] text-[20px]'>Home</span>
                        <span className='text-white text-[20px]'>|</span>
                        <span className='text-white text-[20px]'>Services</span>
                        {service && <span className='text-white text-[20px]'>|</span>}
                        {service && <span className='text-white text-[20px]'>{service.name}</span>}
                    </div>
                ...
                <div className='flex sm:gap-4 gap-2 w-full items-center justify-center md:justify-start md:items-start text-center md:text-start'>
                    <div className='flex gap-2 sm:w-[70%] md:w-[80%] w-full flex-col'>
                        ...
                        <span className="text-[18px] font-bold font-sans text-white">
                            — Satya Nadella
                        </span>
                    </div>
                </div>
