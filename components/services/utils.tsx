...
export const Services = [
    {
        ...
        badge: 'ENGINEERING',
        image: '/service/product_engineering.svg',
        content: [
            {
        ...
        content: [
            {
                ...
                description: 'Develop clear, actionable strategies that align with your business goals and user needs. Our strategic approach ensures every design decision is purposeful and user-focused.',
