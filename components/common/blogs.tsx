...
import { BlogsDetails } from '@/lib/utils';
...
export const Blogs = () => {
    return (
        <section className='w-full flex flex-col'>
            <SectionLabel label='Blogs' placement='left' />
            <ContainerProvider>
                <div className='flex flex-col sm:gap-[60px] gap-10'>
                    <div className='w-full flex items-end justify-between'>
                        <div className='flex flex-col gap-4 w-full md:w-[65%]'>
                            <span className='text-[clamp(18px,3vw,32px)] w-full font-bold underline underline-offset-[12px] decoration-white/20 decoration-1 text-white'>Blogs & Articles</span>
                            <p className='w-full text-[clamp(12px,2vw,20px)] text-white/80'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidi</p>
                        </div>
