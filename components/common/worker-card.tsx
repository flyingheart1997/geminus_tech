...
export const WorkerCard = ({ children, className }: { children: ReactNode, className?: string }) => {
    return (
        <Card className={cn("w-full flex h-auto overflow-hidden bg-gradient-to-b from-[rgba(12,12,12,0.85)] to-[rgba(41,41,41,0.1)]  via-[rgba(41,41,41,0.2)] p-[1px]", className)}>
