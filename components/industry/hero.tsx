...
export const Hero = () => {
    ...
    return (
        <section id='hero' className="h-screen w-screen relative flex items-start md:items-center justify-center py-32 md:p-0 gap-[clamp(20px,4vw,40px)] overflow-hidden bg-[#020103]">
            <motion.div
                ...
                <Image src="/bg_industry.svg" alt="arrow down" height={100} width={100} className="object-contain w-full opacity-60" />
            </motion.div>
            <motion.div
            ...
            >
                <div className='flex flex-col sm:gap-4 gap-2'>
                    <div className='flex gap-2 items-center w-full md:justify-start justify-center'>
                        ...
                        <span className='text-white text-[20px]'>Industry</span>
                    </div>
